    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      app.use(require('webpack-hot-middleware')(
        webpackCompiler.compilers.find(compiler => compiler.name === 'client'), {
          ...
          path: "/restaurantconsole_hmr"
      }));
      app.use('/restaurantconsole', webpackHotServerMiddleware(webpackCompiler));
      ...
      const webpackCompiler = webpack([webpackConf0, webpackConf1], () => {
        ...
        app.use('/restaurantconsole', express.static(path.join(__dirname, 'build', 'public')));
        app.use('/restaurantconsole', serverRenderer({}));
